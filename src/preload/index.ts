...
const api: LauncherApi = {
  ...
  downloadPet: (petId) => ipcRenderer.invoke('launcher:download-pet', petId),
  previewPet: (petId) => ipcRenderer.invoke('launcher:preview-pet', petId),
  applyPet: (petId) => ipcRenderer.invoke('launcher:apply-pet', petId),
  applyPetToDesktop: (petId) => ipcRenderer.invoke('launcher:apply-pet-to-desktop', petId),
  stopDesktopPet: () => ipcRenderer.invoke('launcher:stop-desktop-pet'),
  removePet: (petId) => ipcRenderer.invoke('launcher:remove-pet', petId),
  togglePetFavorite: (petId) => ipcRenderer.invoke('launcher:toggle-pet-favorite', petId),
