...
This repository publishes the free, signed pet catalog used by the Deep Blue DeepSeekHarness Launcher. It currently contains 56 pets, including 50 new original transparent animated WebP companions.
...
Original project media is released under CC0 1.0. Contributions must be original or carry a redistribution-compatible license and must remain suitable for all ages.
